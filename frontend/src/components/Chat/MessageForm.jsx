      ...
      {() => (
        <Form noValidate="" className="py-1 border rounded-2">
          <div className="input-group has-validation">
            <Field name="message" aria-label="typeMessage" placeholder={t('messages.typeMessage')} id="typeMessage" className="border-0 p-0 ps-2 form-control" />
            <label htmlFor="typeMessage" className="visually-hidden">{t('messages.typeMessage')}</label>
